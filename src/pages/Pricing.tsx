...
const Pricing = () => {
  ...
  const plans = [
    ...
    },
    {
      ...
      buttonClass: "bg-gradient-to-r from-primary/50 to-primary text-white hover:shadow-lg hover:scale-105",
      popular: true,
      icon: Star,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-white to-primary/5 pb-20">
      ...
      {/* Header */}
      <div className="relative z-10 bg-white/80 backdrop-blur-sm shadow-sm border-b border-primary/10">
      ...
      <div className="relative z-10 p-4">
        <div className="max-w-md mx-auto">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-1 shadow-lg border border-primary/10">
            <div className="flex">
              <button
      ...
      <div className="relative z-10 p-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            ...
            <div className="flex items-center justify-center space-x-2 mt-4 text-primary">
                ...
                >
                  {plan.popular && (
                    <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                      <Badge className="bg-gradient-to-r from-primary/50 to-primary text-white px-6 py-2 text-sm font-bold shadow-lg">
                  ...
                  <div className="text-center mb-6">
                    <div className={`w-20 h-20 mx-auto mb-4 rounded-3xl flex items-center justify-center relative overflow-hidden ${
                      ...
                      plan.id === 'premium' ? 'bg-gradient-to-br from-primary/10 to-emerald-200' : 'bg-gradient-to-br from-amber-100 to-amber-200'
                    }`}>
                      {plan.id !== 'free' && (
                      ...
                      <Icon className={`w-10 h-10 relative z-10 ${
                        ...
                        plan.id === 'premium' ? 'text-primary' : 'text-amber-600'
                      }`} />
                    </div>
          ...
          {/* Feature Comparison */}
          <div className="mt-16 bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-primary/10 p-8">
            <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center">Why Choose LoveQuest?</h3>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="w-16 h-16 bg-gradient-to-br from-primary/10 to-emerald-200 rounded-2xl flex items-center justify-center mx-auto mb-4">
          ...
          {/* FAQ Section */}
          <div className="mt-12 bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-primary/10 p-8">
      ...
      {/* Bottom accent */}
      <div className="relative z-10 h-2 bg-gradient-to-r from-primary/50 via-emerald-600 to-primary/90 mt-8"></div>
    </div>
  );
};
