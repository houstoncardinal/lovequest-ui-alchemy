  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="text-center max-w-4xl mx-auto">
        ...
        <p className="text-lg md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed mb-8">The luxury Muslim dating & marriage app. Find your soulmate, the halal way.</p>
        
        {/* Desktop/Mobile responsive feature highlights */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 text-left">
          <div className="bg-card/50 backdrop-blur-sm p-6 rounded-lg border border-border/50 hover:bg-card/70 transition-colors">
            <h3 className="text-lg font-semibold mb-2 text-foreground">Halal Connections</h3>
            <p className="text-muted-foreground text-sm">Connect with like-minded Muslims seeking marriage in a respectful, Islamic environment.</p>
          </div>
          <div className="bg-card/50 backdrop-blur-sm p-6 rounded-lg border border-border/50 hover:bg-card/70 transition-colors">
