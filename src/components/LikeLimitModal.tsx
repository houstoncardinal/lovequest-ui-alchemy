...
const LikeLimitModal: React.FC<LikeLimitModalProps> = ({ isOpen, onClose, resetTime }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md mx-auto bg-gradient-to-br from-white via-emerald-50 to-white border-2 border-primary/20 shadow-2xl">
        <DialogHeader className="text-center pb-2">
          <div className="mx-auto mb-4 relative">
            <div className="w-20 h-20 bg-gradient-to-br from-emerald-400 to-primary rounded-full flex items-center justify-center shadow-xl animate-pulse">
        ...
        <div className="space-y-6 text-center">
          ...
          <div className="space-y-4">
            <div className="text-left bg-gradient-to-r from-primary/50 to-primary rounded-2xl p-4 text-white">
            ...
            <div className="flex gap-3">
              ...
              <Button 
                ...
                className="flex-1 bg-gradient-to-r from-primary/50 to-primary hover:from-primary hover:to-primary/90 text-white shadow-lg hover:shadow-xl transition-all duration-300"
              >
