      ...
      {menuItems.map((item) => {
        ...
        return (
          <button
            ...
            className="flex flex-col items-center justify-center relative flex-1 py-1 min-w-0 min-h-0 group focus:outline-none transition-all duration-200 hover:bg-primary/5/40 active:bg-primary/10/60 rounded-xl"
          ...
          >
            <span className="relative flex items-center justify-center">
              ...
              {item.notificationCount && item.notificationCount > 0 && (
                <span
                  className="absolute -top-1.5 -right-1.5 bg-primary/50 text-white text-[10px] font-bold rounded-full w-5 h-5 flex items-center justify-center border-2 border-white ring-2 ring-emerald-200 shadow"
            ...
            {isActive && (
              <span
                className="absolute left-1/2 -bottom-2 -translate-x-1/2 w-10 h-2 rounded-full bg-gradient-to-r from-emerald-400 to-primary shadow-md"
